...
<head>
  ...
  <link href="<?php echo base_url().'assets/assets/css/bootstrap.css'?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo base_url().'assets/assets/css/jquery.datatables.min.css'?>" rel="stylesheet" type="text/css"/>
  <link href="<?php echo base_url().'assets/assets/css/dataTables.bootstrap.css'?>" rel="stylesheet" type="text/css"/>
